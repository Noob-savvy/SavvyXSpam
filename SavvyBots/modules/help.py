...
HELP_STRING = f"★ 𝐁ᴏᴛs 𝐇ᴇʟᴘ 𝐌ᴇɴᴜ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: [☣ⁿᵒᵒᵇ⚚Տᗩᐯᐯϒ ☠](https://instagram.com/noob_savvy)︎**"
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Savvy Bots !! @Savvy_Robot", cache_time=0, alert=True)
